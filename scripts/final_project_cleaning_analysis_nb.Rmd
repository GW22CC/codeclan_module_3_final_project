...
Sharp increase 2012 to 2013 deom 35% to 70% then dips in 2017 and 2018 then up. Unclear why and may be by chance issuing of surveys to rural and urban respondents.
...
shs_disaggregated_for_model %>%
  mutate(dissatisfied_with_nearest_green = if_else(satisfaction_with_nearest_green_space %in% c("Fairly dissatisfied", "Very dissatisfied"), "Yes", "No"), .after = satisfaction_with_nearest_green_space) %>% 
  count(nearest_green_space_use) %>% 
  ggplot() +
  aes(x = nearest_green_space_use, fill = dissatisfied_with_nearest_green) +
  geom_bar() +
  ggtitle("Utilisation of Nearest green space usage by respondents who are \"Fairly dissatisfied\" or \"Very dissatisfied\" with condition") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1)) +
  xlim("Every day", "Several times a week", "Once a week", "Several times a month", "Once a month", "Less often", "Not at all")
...
shs_disaggregated_for_model %>%
  ...
  ggtitle("Utilisation of Nearest green space usage by good local access or not") +
  xlim("Every day", "Several times a week", "Once a week", "Several times a month", "Once a month", "Less often", "Not at all") +
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust = 1))
